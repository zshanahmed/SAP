...
def fill_out_undergrad(chromeBrowser):
    ...
    chromeBrowser.find_element_by_xpath(
        "/html/body/div[1]/div/div/div/div/div/form/div[7]/div[4]/div/input[1]"
    ).click()
    chromeBrowser.find_element_by_xpath(
        "/html/body/div[1]/div/div/div/div/div/form/div[7]/div[1]/div/input[1]"
    ).click()
    chromeBrowser.find_element_by_xpath(
        "/html/body/div[1]/div/div/div/div/div/form/div[7]/div[5]/div/input[1]"
    ).click()
    chromeBrowser.find_element_by_xpath(
        "/html/body/div[1]/div/div/div/div/div/form/div[7]/div[6]/div/input[1]"
    ).click()
    chromeBrowser.find_element_by_xpath(
        "/html/body/div[1]/div/div/div/div/div/form/div[7]/div[7]/div/input[1]"
    ).click()
...
def fill_out_grad(chromeBrowser):
    ...
    chromeBrowser.find_element_by_xpath(
        "/html/body/div[1]/div/div/div/div/div/form/div[7]/div[2]/div/input[1]"
    ).click()
...
def fill_out_staff(chromeBrowser):
    ...
    chromeBrowser.find_element_by_id("howHelp").send_keys(
        "you cannot help me, for I am just a sea sponge"
    )
    chromeBrowser.find_element_by_id("submit_new_ally").click()
...
def fill_out_faculty(chromeBrowser):
    chromeBrowser.find_element_by_xpath(
        "/html/body/div[1]/div/div/div/div/div/form/div[7]/div[3]/div/input[1]"
    ).click()
    chromeBrowser.find_element_by_xpath(
        "/html/body/div[1]/div/div/div/div/div/form/div[7]/div[4]/div/input[1]"
    ).click()
    ...
    chromeBrowser.find_element_by_xpath(
        "/html/body/div[1]/div/div/div/div/div/form/div[7]/div[6]/div/input[2]"
    ).click()
    chromeBrowser.find_element_by_xpath(
        "/html/body/div[1]/div/div/div/div/div/form/div[7]/div[7]/div/input[2]"
    ).click()
    chromeBrowser.find_element_by_id("submit_new_ally").click()
...
@then(
    parsers.parse(
        'be able to login with username "{username}", and password "{password}"'
    )
)
