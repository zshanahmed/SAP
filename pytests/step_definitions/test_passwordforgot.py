...
scenarios('../features/passwordforgot.feature')
...
@given(parsers.parse("I have navigated to Forgot Password page"))
def goto_signup(chromeBrowser):
    chromeBrowser.get(localhost)
    chromeBrowser.find_element_by_id("password-forgot").click()
