...
class Ally(models.Model):
    ...
    ##Grad and Faculty
    area_of_research = ArrayField(models.CharField(max_length=200), null=True)
    ...
    willing_to_mentor_types = ArrayField(models.CharField(max_length=200), null=True)
    ...
    identity = ArrayField(models.CharField(max_length=200), null=True)
