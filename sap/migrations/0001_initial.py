# Generated by Django 3.1 on 2021-04-08 23:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_time', models.DateTimeField(default=models.DateTimeField())),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invitee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sap.ally')),
            ],
        ),
        migrations.CreateModel(
            name='EventAttendeeRelation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attendee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sap.ally')),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='sap.event')),
            ],
        ),
        migrations.CreateModel(
